...
export default function MentorMedsosEdit({ mediaSosial }: any) {
    ...
    const submit: FormEventHandler = (e) => {
        e.preventDefault();
        post('/mentor/medsos/edit');
    };

    return (
        <AppLayout breadcrumbs={[{ title: 'Profile Mentor', href: '/mentor/profile' }, { title: 'Edit Media Sosial', href: '/mentor/medsos/edit' }] }>
            <div className="px-4 py-6">
                <Heading title="Edit Media Sosial" description="Perbarui tautan media sosial Anda sebagai mentor magang." />
