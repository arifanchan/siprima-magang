...
Route::middleware('auth')->group(function () {
    ...
    Route::get('/profile/student/edit', [\App\Http\Controllers\StudentEditController::class, 'edit'])->name('profile.student.edit');
    Route::post('/profile/student/edit', [\App\Http\Controllers\StudentEditController::class, 'update'])->name('profile.student.update');
    Route::get('/profile/medsos/edit', [\App\Http\Controllers\MediaSosialEditController::class, 'edit'])->name('profile.medsos.edit');
